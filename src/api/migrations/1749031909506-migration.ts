...
export class Migration1749031909506 implements MigrationInterface {
    name = 'Migration1749031909506'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("login" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "password" character varying(255) NOT NULL, "isAdmin" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_a62473490b3e4578fd683235c5e" PRIMARY KEY ("login"))`);
        ...
        await queryRunner.query(`CREATE TABLE "test" ("id" SERIAL NOT NULL, "model" character varying(255) NOT NULL, "payload" text NOT NULL, CONSTRAINT "UQ_a05a3dc7a9f2f37818644651b1a" UNIQUE ("model", "payload"), CONSTRAINT "PK_5417af0062cf987495b611b59c7" PRIMARY KEY ("id"))`);
